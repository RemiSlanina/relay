...
export const palette = {
  ...
  secondaryDark: "#5F7F70", // addition for dark mode
...
export const Colors = {
  light: {
    ...
    textInput: palette.text, // currently always dark
    textInputSecondary: palette.textSecondary, // currently always medium dark
  ...
  dark: {
    ...
    error: palette.error,
    errorBackground: palette.errorBackgroundDark,
    success: palette.success,
    warning: palette.warning,
  },
};
