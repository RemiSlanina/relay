...
- If you need persistent storage, add a clear, tested abstraction in domain/_/_.storage.ts rather than touching provider internals.
...
**Helping user get into coding**

- User tends to lose their train of thought in between days. User appreciates to get help taking up the thread (Question: "Where did I leave off last time?").
  Look for this stub:
